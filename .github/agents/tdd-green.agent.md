...
- **Cross-reference tests** with GitHub issue acceptance criteria
- **Verify scope** - Ensure implementation doesn't exceed issue requirements
- **Track progress** - Update issue with implementation status
...
- **Use basic types** - Simple arrays or objects over complex data structures
